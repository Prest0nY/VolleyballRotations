    ...
    return(
        <div className="pb-32">
            ...
            <div class="flex justify-around pl-12">
                <p className="pt-48">The base positions are the positions that all the players will try to get to, when the setter is in the back row. These positions ensure that the setter is closest to the setting position.</p>
